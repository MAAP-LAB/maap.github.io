...
WANDB_KEY = "5724c2feaebd7276d24c8e08620358d6a4377c2f"  # Weights and Biases API key
...
CLAMP3_TRAIN_JSONL = "/home/elicer/clamp3/Assets/train_1.jsonl"  # Path to the JSONL file with training data for CLaMP3
CLAMP3_EVAL_JSONL = "/home/elicer/clamp3/Assets/test_1.jsonl"  # Path to the JSONL file with evaluation data for CLaMP3 (optional)
